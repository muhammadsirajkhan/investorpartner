...
if($banner){
    ...
    if($review){
        ...
        $review_sub_title = $review['sub_title'];
        $review_content = $review['content'];
    }
}
?>
<section class="banner-section" style="background-image: url(<?php echo $image ?? ''; ?>);">
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-5">
                <div class="banner-content">
                    ...
                    <a href="<?php echo $link_url ?? ''; ?>" class="btn btn-primary rounded-pill"><?php echo $link_title ?? ''; ?></a>
                    <div class="review-summary mt-4">
                        <p><span class="rating">5/5</span> <?php echo $rating ?? ''; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="banner-media">
                    ...
                    <div class="review-box">
                        <div class="d-flex align-items-center">
                            <img src="<?php echo $review_image ?? ''; ?>" alt="Andrew Steel" class="review-avatar" width="60" height="60">
                            <div class="review-meta ms-3">
                                <h5 class="review-author mb-0"><?php echo $review_title ?? ''; ?></h5>
                                <small class="text-muted"><?php echo $review_sub_title ?? ''; ?></small>
                            </div>
                        </div>
                        <p class="review-text mt-3"><?php echo $review_content ?? ''; ?></p>
                    </div>
                </div>
            </div>
        </div>
...
if($featured_section){
    ...
    $icons = $featured_section['icons'];
    $youtube_video = $featured_section['youtube_video'];
}
?>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 feature-logos">
                <h2 class="feature-title mb-5"><?php echo $title ?? ''; ?></h2>
                <div class="feature-grid">
                    <div class="row g-4 align-items-center">
                        ...
                        ?>
                                <div class="col-4 text-center"><img src="<?php echo $icon['items'] ?? ''; ?>" class="img-fluid" alt="<?php echo $icon['alt_content'] ?? ''; ?>" loading="lazy"></div>
                        <?php 
                            endforeach;
                        endif;
                        ?>
            ...
            <div class="col-lg-6 feature-video">
                <div class="ratio ratio-16x9">
                    <iframe loading="lazy" src="https://www.youtube.com/embed/<?php echo $youtube_video ?? '-cNj8my-nY8'; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" class="rounded-4" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
...
if($right_image){
    $image = $right_image['image'];
    $content = $right_image['content'];
}
?>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <?php echo $content ?? ''; ?>
                    <!-- <h2>Are you Ready to build Wealth Without Compromising Lifestyle?</h2>
            ...
            <div class="col-lg-6">
                <div class="about-image text-lg-end text-center">
                    <img loading="lazy" class="img-fluid rounded-4" src="<?php echo $image ?? ''; ?>" alt="Property Investment">
                </div>
            </div>
        </div>
    </div>
...
if($left_image){
    $image = $left_image['image'];
    $content = $left_image['content'];
}
?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="property-goals-image">
                    <img loading="lazy" src="<?php echo $image ?? ''; ?>" class="img-fluid rounded-4" alt="Property Investment">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="property-goals-content">
                    <?php echo $content ?? ''; ?>
                    <!-- <h2>Make your Property Goals A Reality with IPG!</h2>
...
<?php 
$feasibility = get_field('feasibility');
if($feasibility){
    $title = $feasibility['title'];
    $link = $feasibility['link'];
    if($link){
        $link_url = $link['url'];
        $link_title = $link['title'];
    }
    $review = $feasibility['review'];
    if($review){
        $review_image = $review['image'];
        $review_title  = $review['title'];
        $review_sub_title = $review['sub_title'];
    ...
    $feasibilities_items = $feasibility['feasibilities_items'];
}
?>
    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-5 mb-4 mb-lg-0" data-aos="fade-left">
                <div class="feasibility-left">
                    <h2 class="section-title mb-4"><?php echo $title ?? ''; ?></h2>
                    <div class="mb-4">
                        <a href="<?php echo $link_url ?? ''; ?>" class="btn btn-primary rounded-pill"><?php echo $link_title ?? ''; ?></a>
                    </div>
                    <div class="review-box mt-0 bg-light p-4 rounded-4 shadow-sm">
                        <div class="d-flex align-items-center mb-3">
                            <img loading="lazy" src="<?php echo $review_image ?? ''; ?>" class="rounded-circle me-3" alt="Alex Parker">
                            <div>
                                <h3 class="h5 mb-1"><?php echo $review_title ?? ''; ?></h3>
                                <p class="text-muted small mb-0"><?php echo $review_sub_title ?? ''; ?></p>
                            </div>
                        </div>
                        <p class="mb-0 small"><?php echo $review_content ?? ''; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6" data-aos="fade-right">
                <?php 
                    if($feasibilities_items) :
                        foreach($feasibilities_items as $item) :
                ?>
                <div class="features-list">
                    <div class="feature-item mb-4">
                        <div class="d-flex mb-3">
                            <img loading="lazy" decoding="async" width="70" height="70" src="<?php echo $item['icon'] ?? ''; ?>" class="me-3" alt="">
                            <div class="feature-content">
                                <?php echo $item['content'] ?? ''; ?>
                                <!-- <h4>Your Trusted Partner for Real Estate Success</h4>
                    ...
                    <!-- <div class="feature-item mb-4">
                        <div class="d-flex mb-3">
                            ...
                            <div class="feature-content">
                                <h4>Connecting You to Top Industry Professionals</h4>
                    ...
                    <div class="feature-item mb-4">
                        <div class="d-flex mb-3">
                            ...
                            <div class="feature-content">
                                <h4>Transparency You Can Trust in Every Deal</h4>
                    ...
                    <div class="feature-item mb-4">
                        <div class="d-flex mb-3">
                            ...
                            <div class="feature-content">
                                <h4>Experience-Driven Proposals for Immediate Equity Growth</h4>
                    ...
                    <div class="feature-item">
                        <div class="d-flex mb-3">
                            ...
                            <div class="feature-content">
                                <h4>Inclusive Property Services with Rental Guarantees</h4>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center mb-4">
                ...
                <p>We pride ourselves on delivering exceptional service and building strong relationships with our clients. Here’s what some of our satisfied customers have to say about their experience with us.</p> -->
            </div>
        </div>

        <div class="client-testimonials-wrap position-relative">
            <div class="swiper client-testimonials py-1">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="client-item bg-white rounded-4 overflow-hidden shadow-sm text-center">
                            <iframe loading="lazy" src="https://www.youtube.com/embed/<?php echo $item['youtube_video'] ?? ''; ?>" frameborder="0" class="" allowfullscreen></iframe>
                            <h4 class="client-name mb-3 mt-2"><?php echo $item['title'] ?? ''; ?></h4>
                        </div>
                    </div>
                    <?php 
                        endforeach;
...
<?php 
$video_tab = get_field('video_tab');
if($video_tab){
    $main_title = $video_tab['main_title'];
    $sub_title = $video_tab['sub_title'];
    $content = $video_tab['content'];
    $tabs = $video_tab['tabs'];
}
?>
<section class="video-tabs-section">
    <div class="video-tab-content position-relative py-5" style="background-image: url('<?php if($tabs) : foreach($tabs as $key => $item) : if($key===0) : echo $item['image'];  endif; endforeach; endif; ?>');">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-8">
                <h2 class="section-title text-white text-center mb-4"><?php echo $main_title ?? ''; ?></h2>
                <h3 class="text-center text-white mb-4"><?php echo $sub_title ?? ''; ?></h3>
                <p class="text-center text-white mb-4"><?php echo $content ?? ''; ?></p>
                </div>
                <div class="col-lg-12">
                    <div class="video-tabs">
                            ...
                            if($tabs) :
                                foreach($tabs as $key => $item) :
                                    if($key===0) :
                            ?>
                                <button class="btn btn-play video-modal-trigger" type="button" data-bs-toggle="modal" data-bs-target="#videoModal" data-video-id="<?php echo $item['youtube_video'] ?? ''; ?>">
                            ...
                            ?>
                            <div class="video-tabs-nav mt-5">
                                <div class="d-flex gap-3 justify-content-center">
                                    <?php 
                                        if($tabs) :
                                            foreach($tabs as $key => $item) :
                                    ?>
                                        <button class="btn btn-tab btn-outline-light rounded-5 <?php if($key === 0) : echo 'active'; endif; ?>" data-bg="<?php echo $item['image'] ?? ''; ?>" data-video-id="<?php echo $item['youtube_video'] ?? ''; ?>"><?php echo $item['button'] ?? ''; ?></button>
                                    <?php 
                                        endforeach;
                                    endif;
                                    ?>
                                    ...
                                    <!-- <button class="btn btn-tab btn-outline-light rounded-5 active" data-bg="<?php echo get_template_directory_uri(); ?>/assets/img/video-bg-1.jpg" data-video-id="WeBM2vDgf5U">Rex Pangan</button>
                                    <button class="btn btn-tab btn-outline-light rounded-5" data-bg="<?php echo get_template_directory_uri(); ?>/assets/img/video-bg-2.jpg" data-video-id="W8YSeEcouR8">Christine and Owen Nebril</button>
                                    <button class="btn btn-tab btn-outline-light rounded-5" data-bg="<?php echo get_template_directory_uri(); ?>/assets/img/video-bg-3.jpg" data-video-id="e68RqPm7byE">Shreeya and Maninder Pandey</button>
                                    <button class="btn btn-tab btn-outline-light rounded-5" data-bg="<?php echo get_template_directory_uri(); ?>/assets/img/video-bg-4.jpg" data-video-id="4dPENeE8ia8">Rajan Sharma</button>
                                    <button class="btn btn-tab btn-outline-light rounded-5" data-bg="<?php echo get_template_directory_uri(); ?>/assets/img/video-bg-5.jpeg" data-video-id="mqg-1qQa9Xs">Tony Saunders</button> -->
                                </div>
                            </div>
                        </div>
                </div>
...
if($contact){
    ...
    $main_title = $contact['main_title'];
    $content = $contact['content'];
    $image = $contact['image'];
}
?>
<section class="contact-sec free-ebook-section py-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 contact-left">
                <div class="contact-wrap">
                    <h2 class="contact-title mb-2"><?php echo $sub_title ?? ''; ?></h2>
                    <h2 class="contact-subtitle mb-4"><?php echo $main_title ?? ''; ?></h2>
                    <p class="contact-text mb-4"><?php echo $content ?? ''; ?></p>
            ...
            <div class="col-lg-4 contact-right">
                <div class="image-wrap text-end">
                    <img loading="lazy" src="<?php echo $image ?? ''; ?>" class="img-fluid" alt="Investment Image" width="380" height="519">
                </div>
            </div>
        </div>
    </div>
